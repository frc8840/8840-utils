...
public class SwerveModuleOld extends IOLayer {
    //Ports
     ...
     */
    public SwerveModuleOld(int drivePort, int steerPort, int encoderPort, int swerveNum, CTREConfig config) {
        super();
        ...
        SwerveModuleOld thisModule = this;
